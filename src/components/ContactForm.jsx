...
function ContactForm() {
  ...
  */
  ...
  if (status === "success") {
    return (
      <div className="min-h-screen bg-gradient-to-r  from-amber-200 via-indigo-100 to-cyan-200 flex items-center justify-center p-4">
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-tr  from-amber-200 via-indigo-100 to-cyan-200">
